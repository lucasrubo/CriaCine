        ...
        <div className="lg:hidden">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="grid w-full grid-cols-4">
              ...
              <TabsTrigger value="poster" className="text-xs">
                Cartazes
              </TabsTrigger>
              <TabsTrigger value="ai-image" className="text-xs">
                IA
              </TabsTrigger>
            </TabsList>
          </Tabs>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-2">
            {["ficção-científica", "thriller", "drama", "ia", "cyberpunk"].map(
              (relatedTag) => (
                <Badge
                  key={relatedTag}
                  variant="outline"
                  ...
                  onClick={() =>
                    navigate(`/search?tag=${encodeURIComponent(relatedTag)}`)
                  }
                >
                  #{relatedTag}
                </Badge>
